...
type CreateMessageResponse struct {
	...
	Message   *base.Message `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
...
func (x *CreateMessageResponse) GetMessage() *base.Message {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *CreateMessageResponse) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
...
func (x *CreateReplyResponse) GetMessage() *base.Message {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *CreateReplyResponse) GetChannelId() string {
	if x != nil {
		return x.ChannelId
	}
	return ""
...
var file_schema_response_message_response_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x73, 0x22, 0x5f, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x0b, 0x32, 0x0d, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x22, 0x5d, 0x0a, 0x13, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x27, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0d, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52,
	...
	0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x64, 0x42, 0xcf, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e,
...
var file_schema_response_message_response_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_schema_response_message_response_proto_goTypes = []any{
	...
	(*CreateReplyResponse)(nil),    // 2: schema.response.CreateReplyResponse
	(*base.Message)(nil),           // 3: base.Message
}
var file_schema_response_message_response_proto_depIdxs = []int32{
	3, // 0: schema.response.GetByChannelIDResponse.messages:type_name -> base.Message
	3, // 1: schema.response.CreateMessageResponse.message:type_name -> base.Message
	3, // 2: schema.response.CreateReplyResponse.message:type_name -> base.Message
